...
async function fetchMeetups(): Promise<MeetupDTO[]> {
...
const filteredMeetups = computed(() => {
  ...
  return meetups.value.filter((meetup: MeetupDTO) => dateFilter(meetup) && participationFilter(meetup) && searchFilter(meetup))
})
